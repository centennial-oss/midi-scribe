...
# Build info generation: BuildInfoGenerated.swift used by BuildInfo.swift.
...
build-release-unsigned:
	...
	xcodebuild -scheme "$(XCODE_SCHEME)" -configuration Release -derivedDataPath dist/DerivedData -destination 'platform=macOS' build CODE_SIGN_IDENTITY="" CODE_SIGNING_REQUIRED=NO CODE_SIGNING_ALLOWED=NO
	xcodebuild -scheme "$(XCODE_SCHEME)" -configuration Release -derivedDataPath dist/DerivedData -destination 'generic/platform=iOS' build CODE_SIGN_IDENTITY="" CODE_SIGNING_REQUIRED=NO CODE_SIGNING_ALLOWED=NO
	cp -R "dist/DerivedData/Build/Products/Release/MIDI Scribe.app" "dist/MIDI Scribe-macOS.app"
	cp -R "dist/DerivedData/Build/Products/Release-iphoneos/MIDI Scribe.app" "dist/MIDI Scribe-iOS.app"
